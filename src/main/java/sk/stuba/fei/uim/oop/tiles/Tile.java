    ...
    private void changeAccessibleNeighbors() {
        ...
        if (this.type.equals(Type.I)) {
            if (this.rotation.equals(Rotation.LEFT_RIGHT)) {
                accessibleNeighbors.add(new Node(Direction.LEFT.getX(), Direction.LEFT.getY()));
                accessibleNeighbors.add(new Node(Direction.RIGHT.getX(), Direction.RIGHT.getY()));
            } else if (this.rotation.equals(Rotation.UP_DOWN)) {
                accessibleNeighbors.add(new Node(Direction.UP.getX(), Direction.UP.getY()));
                accessibleNeighbors.add(new Node(Direction.DOWN.getX(), Direction.DOWN.getY()));
            }
        }
        if (this.type.equals(Type.L)) {
